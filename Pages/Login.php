...
<head>
  ...
  <link rel="stylesheet" href="<?='/bet_community/Public/css/login.css?v=' . BetCommunity::CSS['login.css']?>">
</head>
<body>
    ...
    <script src="<?='/bet_community/Public/js/login.js?v=' . BetCommunity::JS['login.js']?>"></script>
